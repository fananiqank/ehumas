...
<form class="form-user" id="form" method="post" enctype="multipart/form-data" novalidate autocomplete="off">
    <div class="col-sm-12">
           ...
           <div class="form-group row">
                <label class="col-sm-2" style="font-size: 13px;"><b>Nama alat</b></label>
                <div class="col-4">: 
                    <?=$val2[kalbar_name]?>
                </div>
                <label class="col-sm-2" style="font-size: 13px;"><b>Type Alat</b></label>
                <div class="col-4">: 
                    <?=$val2[kalbar_type]?>
                </div>
            ...
            <div class="form-group row">
                <label class="col-sm-2" style="font-size: 13px;"><b>Lokasi Alat</b></label>
                <div class="col-4">: 
                    <?=$val2[kalbar_lokasi]?>
                </div>
                <label class="col-sm-2" style="font-size: 13px;"><b>Jenis Perijinan</b></label>
                <div class="col-4">: 
                    <?=$val2[jeniskalbar]?>
                </div>
