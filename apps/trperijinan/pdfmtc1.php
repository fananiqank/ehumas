...
$pdf->Cell(190,7,"Form : F-WINA/PGA/16/073",0,1,'R');
$pdf->Cell(190,7,"Tanggal Pengajuan : ",0,0,'R');
// $pdf->Cell(190,7,"SK No:".$val2[ijin_nosk],0,0,'R');
$pdf->ln(12);
...
$pdf->Cell(35,5,"NOMOR PASPOR",0,0,'L');
$pdf->Cell(4,5,":",0,0,'L');
$pdf->Cell(39,5,$val2[ijin_nik],0,1,'L');

$pdf->Cell(35,5,"JENIS VISA",0,0,'L');
$pdf->Cell(4,5,":",0,0,'L');
$pdf->Cell(39,5,"211a/211B Single-Entry     /  Multiple-Entry (VKUBP)",0,1,'L');

$pdf->Cell(35,5,"MASA TINGGAL",0,0,'L');
$pdf->Cell(4,5,":",0,0,'L');
$pdf->Cell(39,5,"Tgl____________20  S/D  20________",0,1,'L');
...
$pdf->Cell(35,5,"KEPERLUANNYA",0,0,'L');
$pdf->Cell(4,5,":",0,0,'L');
$pdf->Cell(50,5,$val2[ijin_keterangan],0,1,'L');

$pdf->Cell(45,5,"Alamat Kantor Kedutaan RI",0,0,'L');
$pdf->Cell(4,5,":",0,0,'L');
$pdf->Cell(50,5,"",0,1,'L');

$pdf->Cell(100,5,"(alamat kantor perwakilan kedutaan RI di negara Ybs/negara yg dipilih untuk memproses visanya )",0,0,'L');
$pdf->Cell(50,5,"",0,1,'L');
