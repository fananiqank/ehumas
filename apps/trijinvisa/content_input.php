...
<div class="row">
    <div class="col-md-6">
        ...
        <label class="col-sm-3 control-label" for="w1-username">Dept.</label>
            <div class="col-sm-9">
                <select class="select2 form-control block headmas" id="dept_id" name="dept_id">
                    <?php include "tampildept.php"; ?>
                </select>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control input-sm headmas" name="jabatan" id="jabatan" style="min-width: 100%;" required>
            </div>
        </div>
        <div class="form-group row form-inline">
        ...
        <label class="col-sm-3 control-label" for="w1-username">Jenis Visa</label>
            <div class="col-sm-5">
                <select class="select2 form-control block headmas" id="bvisa_jenis" name="bvisa_jenis">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                 <input type="date" class="form-control input-sm" id="bvisa_tglawal" name="bvisa_tglawal" value="<?=$mtc[bvisa_tglawal]?>" style="width: 100%">
            </div>
            <div class="col-sm-1" align="center">-</div>
            <div class="col-sm-4">
                 <input type="date" class="form-control input-sm" id="bvisa_tglakhir" name="bvisa_tglakhir" value="<?=$mtc[bvisa_tglakhir]?>" style="width: 100%" >
            </div>
        </div>
        <div class="form-group row">
