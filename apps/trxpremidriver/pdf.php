...
foreach($db->select("(select count(*) as jumlah_hari from txkehadiran where hadirdriver_type='1' and hadirdriver_jenis<>'0' and date(hadirdriver_tgl) between '$basic[txbaspre_tgl1]' and '$basic[txbaspre_tgl2]') a","*") as $basic1){}
...
$pdf->Cell(60,5,"TF Dari Rekening Om Wawan",0,1,'R');
$pdf->ln(2);
$pdf->garis();
$pdf->garis2();
