...
foreach($db->select("(SELECT @rownum:=@rownum+1 norut, b.arm_norangka,b.arm_nopol,b.arm_nolambung,concat(SUBSTR(b.arm_norangka,-5) norangka,'-',b.arm_nolambung) as norabung FROM m_armada b JOIN (SELECT @rownum:=0) r where b.arm_id='$_GET[id]') a","*") as $val2){}
