...
$columns = array(
	...
	array('db'      => 'inv_tgl','dt'   => 2, 'field' => 'inv_tgl',
		   'formatter' => function( $d, $row ) {
...
$joinQuery = "FROM (SELECT  @rownum:=@rownum+1 norut, a.*, b.cust_name FROM `tx_invoice` a JOIN m_customer b ON a.cust_id=b.cust_id JOIN (SELECT @rownum:=0) r) a";
$extraWhere = "";        
